...
import 'package:edu_app/models/new_page_model.dart';
import 'package:edu_app/students_screens/screens/cyberSecure.dart';
import 'package:edu_app/students_screens/utils/utils.dart';
import 'package:edu_app/students_screens/widgets/spinKit.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'user_notifier.dart';
import 'navbar.dart';
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: PageView(
                      ...
                      scrollDirection: Axis.horizontal,
                      children: <Widget>[
                        _buildCard('assets/advertaising3.jpg',
                            'General Science', context),
                        _buildCard('assets/advertaising4.jpg',
                            'Current Affairs', context),
                        _buildCard('assets/advertising2.jpg', 'Current Affairs',
                            context),
                      ],
                    ),
                  ),
